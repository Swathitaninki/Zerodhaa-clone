  ...
  return (
    ...
    <div className="container">
      <div className="row p-5 mt-5 border-bottom text-center">
       <h1>Pricing </h1>
       <h3 className="text-muted mt-5 fs-5">Free enquirey investment and flat 20 trady and  F&Q traders</h3>    
      </div>
        ...
        <div className="col-4 p-5 text-center">
          ...
          <p className="text-muted">
            AFlat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday trades across equity, currency, and commodity trades. Flat ₹20 on all option trades.</p>
             </div>
